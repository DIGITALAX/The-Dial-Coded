...
const Search: FunctionComponent = (): JSX.Element => {
  ...
  return (
    <div className="relative w-full h-full bg-white rounded-t-2xl row-start-3 grid grid-flow-col auto-cols-auto py-6 z-10">
      <div className="relative w-fit h-fit col-start-1 gap-3 grid grid-flow-col auto-cols-auto pl-10">

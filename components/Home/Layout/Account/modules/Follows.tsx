...
const Follows: FunctionComponent<FollowProps> = ({ follow }): JSX.Element => {
  ...
  return (
    <div
      ...
      className="relative w-4/5 h-fit p-2 drop-shadow-lg grid grid-flow-col bg-gray-50/50 auto-cols-auto rounded-lg border border-gray-50 justify-self-center cursor-pointer whitespace-pre-wrap break-all"
    >

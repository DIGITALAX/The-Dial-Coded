...
const IndexingModal: FunctionComponent<IndexingModalProps> = ({message}): JSX.Element => {
  return (
    <div className="w-full h-fit grid grid-flow-col auto-cols-auto col-start-1 bottom-10 pr-6 sticky z-50">

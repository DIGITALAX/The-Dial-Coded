...
const PostFeedLoading: FunctionComponent = (): JSX.Element => {
  return (
    <div className="relative w-full h-full flex flex-col">
      ...
      <div className="relative flex flex-col animate-pulse w-full h-fit row-start-1 self-start md:pt-10">
        <div className="flex-1 space-y-6 py-1">
          <div className="h-2 bg-offBlue/50 rounded"></div>
          <div className="space-y-3">
            <div className="grid grid-cols-3 gap-4">
      ...
      <div className="relative flex flex-col animate-pulse w-full h-fit row-start-1 self-start pt-8 md:pt-10">
        <div className="flex-1 space-y-6 py-1">
          <div className="h-2 bg-offBlue/50 rounded"></div>
          <div className="space-y-3">
            <div className="grid grid-cols-3 gap-4">
